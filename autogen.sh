...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_ara to login script."
...
# the current dir:
if   test x${GTLANG_ara} = x ; then
	echo "WARNING: The variable \${GTLANG_ara} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_ara} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_ara} has the value:"
	echo "  ${GTLANG_ara}"
