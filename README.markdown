...
This directory contains source files for the Arabic language morphology
...
-   <http://giellatekno.uit.no/aradoc/index.html>
-   <https://giellalt.uit.no/tools/docu-ara-manual.html>
-   <https://giellalt.uit.no/index.html>

Requirements
------------

In order to compile and use Arabic language morphology and dictionaries,
you need:
...
The Arabic language sources can be acquired using [giella SVN
